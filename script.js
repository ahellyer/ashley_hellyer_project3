...
pepApp.pepTalks = {
    toughLove: {
        ...
        mistake: [
            ...
            'You are not a perfect snowflake that never does anything wrong. ',
            ...
            'Your poor me attitude is annoying. Quit playing the victom and get over yourself. '
            ],
    ...
    tryYourBest: {
        ...
        comparing: [
            'We struggle with insecurity becuase we compare our behind-the - scenes with everyone else\'s highlight reel! ',
            ...
            'The fastest way to kill somethig special is to compare it to something else! ',        
    ...
    oprah: {
        nervous: [
            ...
            'Doing your best at this moment puts you in the best place for the mext moment. ',
...
pepApp.firstSentence = {
    toughLove: {
        ...
        imposter: (name) => {
            return `What even is imposter syndrome - ugh ${name}. `
        },
        comparing: (name) => {
    ...
    tryYourBest: {
        ...
        imposter:(name) => {
            return `Story of my life, ${name}. We are in this together! `
        },
        comparing: (name) => {
